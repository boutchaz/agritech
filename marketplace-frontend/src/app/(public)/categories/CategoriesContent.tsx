...
import { Loader2, Grid3X3, ChevronRight, Search, ArrowRight } from 'lucide-react';
...
export default function CategoriesContent({ initialCategories }: CategoriesContentProps) {
  ...
  const categories = ((rawCategories.length > 0 ? rawCategories : initialCategories.length > 0 ? initialCategories : fallbackCategories) as Category[]);
