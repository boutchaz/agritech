      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="relative bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 overflow-hidden group/card">
          ...
          <div className="relative">
            <span className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">{t('dashboard.widgets.stock.alerts')}</span>
            <div className={cn(
            ...
            <div className="text-[10px] font-bold text-amber-600 dark:text-amber-400 mt-1 uppercase tracking-tighter">
        ...
        <div className="relative bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-4 overflow-hidden group/card">
          ...
          <div className="relative">
            <span className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">{t('dashboard.widgets.stock.ok')}</span>
