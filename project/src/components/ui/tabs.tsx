...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center gap-2 border-b border-slate-200 dark:border-slate-700 overflow-x-auto sm:gap-6",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex items-center gap-2.5 whitespace-nowrap border-b-2 px-1 py-3 text-sm font-medium transition-all duration-200 sm:gap-3 sm:py-4",
      ...
      "hover:text-slate-800 hover:border-slate-300 dark:hover:text-slate-200",
