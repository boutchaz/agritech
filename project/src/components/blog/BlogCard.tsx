        ...
        <Link to="/blog/$slug" params={{ slug: post.slug }} className="block">
          {imageUrl && (
            <div className="relative h-64 md:h-80 overflow-hidden">
              ...
              {post.blog_category && (
                <span className="absolute top-4 left-4 px-3 py-1 text-xs font-semibold text-white bg-green-600 rounded-full">
      ...
      <Link to="/blog/$slug" params={{ slug: post.slug }} className="block">
        {imageUrl && (
          <div className="relative h-48 overflow-hidden">
            ...
            />
            {post.blog_category && (
              <span className="absolute top-3 left-3 px-2 py-1 text-xs font-semibold text-white bg-green-600 rounded-full">
                {post.blog_category.name}
              </span>
            )}
          </div>
