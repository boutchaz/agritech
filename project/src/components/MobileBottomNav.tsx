...
const moreMenuItems: MoreMenuItem[] = [
  ...
  },
  {
    ...
    labelKey: "nav.workforcePayments",
    fallback: "Worker Payments",
    icon: Banknote,
  ...
  {
    id: "workforce-salary-structures",
    labelKey: "nav.salaryStructures",
    fallback: "Salary Structures",
    icon: ClipboardList,
    path: "/workforce/salary-structures",
  },
  {
    id: "workforce-payroll-runs",
    labelKey: "nav.payrollRuns",
    fallback: "Payroll Runs",
    icon: Receipt,
    path: "/workforce/payroll-runs",
  },
  {
    id: "workforce-salary-slips",
    labelKey: "nav.salarySlips",
    fallback: "Salary Slips",
    icon: FileText,
  ...
  },
  {
    ...
    labelKey: "nav.workforceOnboarding",
    fallback: "Worker Onboarding",
    icon: ClipboardList,
    path: "/workforce/onboarding",
  },
  {
    id: "workforce-separations",
    labelKey: "nav.separations",
    fallback: "Separations",
    icon: AlertTriangle,
    path: "/workforce/separations",
  },
  {
    id: "workforce-seasonal",
    labelKey: "nav.seasonalCampaigns",
    fallback: "Seasonal Campaigns",
    icon: CalendarRange,
    path: "/workforce/seasonal-campaigns",
  },
  {
    id: "workforce-qualifications",
  ...
  {
    id: "workforce-safety",
    labelKey: "nav.safetyIncidents",
    fallback: "Safety Incidents",
    icon: AlertTriangle,
    path: "/workforce/safety-incidents",
  },
  {
    id: "workforce-transport",
    labelKey: "nav.workerTransport",
    fallback: "Worker Transport",
    icon: Truck,
    path: "/workforce/worker-transport",
  },
  {
    id: "workforce-expenses",
    labelKey: "nav.expenseClaims",
    fallback: "Expense Claims",
    icon: Receipt,
  ...
  {
    id: "workforce-hr-analytics",
    labelKey: "nav.hrAnalytics",
    fallback: "HR Analytics",
    icon: PieChart,
