                  ...
                  <Table>
                    <TableHeader className="bg-slate-50">
                      <TableRow className="border-b-slate-100">
                        <TableHead className="text-[10px] font-bold uppercase tracking-wider">{t('satellite:heatmap.multiGrid.indexComparison')}</TableHead>
                        ...
                        <TableHead className="text-right text-[10px] font-bold uppercase tracking-wider">Min / Max</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
