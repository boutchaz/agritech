...
CREATE OR REPLACE FUNCTION "public"."get_user_role"("user_id" "uuid", "organization_id" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("role_name" "text", "role_display_name" "text", "role_level" integer)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION "public"."get_user_role"("user_id" "uuid", "organization_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_user_role_level"("p_user_id" "uuid", "p_organization_id" "uuid") RETURNS integer
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    AS $$
DECLARE
  v_level INTEGER;
...
ALTER FUNCTION "public"."get_user_role_level"("p_user_id" "uuid", "p_organization_id" "uuid") OWNER TO "postgres";
...
COMMENT ON FUNCTION "public"."is_active_org_member"("user_id" "uuid", "org_id" "uuid") IS 'Checks if user is active member of organization AND organization has valid subscription. Used by SELECT RLS policies.';
...
COMMENT ON FUNCTION "public"."user_has_permission_for_org"("user_id" "uuid", "org_id" "uuid", "permission_name" "text") IS 'Checks if user has permission for organization AND organization has valid subscription. Used by INSERT/UPDATE/DELETE RLS policies.';
...
COMMENT ON TRIGGER "enforce_subscription_creation" ON "public"."subscriptions" IS 'Prevents frontend from creating subscriptions directly. Subscriptions must come from payment processor (Polar.sh) or be created manually by admin with service role.';
...
CREATE POLICY "authenticated_can_create" ON "public"."organizations" FOR INSERT WITH CHECK (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "subscription_check_users_insert" ON "public"."organization_users" FOR INSERT TO "authenticated" WITH CHECK (("public"."has_valid_subscription"("organization_id") AND "public"."can_add_user"("organization_id")));
...
GRANT ALL ON FUNCTION "public"."get_user_role"("user_id" "uuid", "organization_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_user_role"("user_id" "uuid", "organization_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_role"("user_id" "uuid", "organization_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_user_role_level"("p_user_id" "uuid", "p_organization_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_user_role_level"("p_user_id" "uuid", "p_organization_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_role_level"("p_user_id" "uuid", "p_organization_id" "uuid") TO "service_role";
