-- =====================================================
-- FIX SEED FUNCTIONS - Drop and recreate with correct schema
-- =====================================================

-- Drop existing functions
DROP FUNCTION IF EXISTS seed_moroccan_chart_of_accounts(UUID);
DROP FUNCTION IF EXISTS seed_french_chart_of_accounts(UUID);
...
BEGIN
  ...
  VALUES
    ...
    (p_org_id, '4450', 'Avances aux fournisseurs', 'Asset', 'Receivable', false, true, 'MAD'),
    ...
    -- Personnel
    (p_org_id, '4480', 'Rémunérations dues au personnel', 'Liability', 'Payable', false, true, 'MAD'),
    (p_org_id, '4482', 'Saisies et oppositions', 'Liability', 'Payable', false, true, 'MAD')
  ON CONFLICT (organization_id, code) DO NOTHING;
