-- =====================================================
-- Migration: Update stock entry trigger to use items table
-- Description: Replaces inventory_items references with stock_valuation system
-- =====================================================

-- =====================================================
-- 1. UPDATE update_stock_on_entry_post() FUNCTION
-- =====================================================
...
-- This migration updates the update_stock_on_entry_post() function to:
-- 1. Use stock_valuation table instead of inventory_items
-- 2. Properly handle FIFO, LIFO, and Moving Average valuation methods
-- 3. Create stock_valuation entries for receipts
-- 4. Reduce remaining_quantity for issues based on valuation method
-- 5. Handle transfers and reconciliations properly
