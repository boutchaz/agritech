...
@Module({
  ...
  providers: [SatelliteIndicesService, SatelliteProxyService, SatelliteCacheService, SatelliteSyncService],
  exports: [SatelliteIndicesService, SatelliteProxyService, SatelliteCacheService, SatelliteSyncService],
})
