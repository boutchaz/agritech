...
// Plantation Systems Route
export const Route = createFileRoute('/_authenticated/reference/plantation-systems')({
    component: () => <GenericReferencePage title="Plantation Systems" table="plantation_systems" />,
});
