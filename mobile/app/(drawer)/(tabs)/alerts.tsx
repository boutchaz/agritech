...
export default function AlertsScreen() {
  return (
    <View style={styles.container}>
      <PageHeader title="Alerts" showBack={false} />
      <View style={styles.body}>
        <Ionicons name="notifications-outline" size={56} color={palette.primary + '33'} />
        <Text style={styles.title}>Alerts</Text>
        <Text style={styles.subtitle}>Parcel alerts, weather warnings, and system notifications</Text>
      </View>
    </View>
  );
}
