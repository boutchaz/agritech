...
export default function FinanceScreen() {
  return (
    <View style={styles.container}>
      <PageHeader title="Finance" showBack={false} />
      <View style={styles.body}>
        <Ionicons name="wallet-outline" size={56} color={palette.primary + '33'} />
        <Text style={styles.title}>Finance</Text>
        <Text style={styles.subtitle}>Revenue, costs, margins across farms</Text>
      </View>
    </View>
  );
}
