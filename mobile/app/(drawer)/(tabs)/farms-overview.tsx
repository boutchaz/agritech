...
export default function FarmsScreen() {
  return (
    <View style={styles.container}>
      <PageHeader title="Farms" showBack={false} />
      <View style={styles.body}>
        <Ionicons name="business-outline" size={56} color={palette.primary + '33'} />
        <Text style={styles.title}>Farms</Text>
        <Text style={styles.subtitle}>Multi-farm overview and comparison</Text>
      </View>
    </View>
  );
}
