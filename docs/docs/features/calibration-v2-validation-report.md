...
| DS-7 | **LOW** | Drought detection ignores irrigation. 30-day under 5mm precip triggers `prolonged_drought`. Irrigated orchards trigger this every summer. | False positives. Alert fatigue for irrigated farms. | Add irrigation flag. Suppress drought alerts for irrigated parcels or increase threshold. |
